...
```{r Exercise 1.1}
clinical <- read.csv("/PATH/TO/analysis_data/skcm_clinical_data.csv")
```
...
write.csv(clinical, "/PATH/TO/analysis_data/skcm_clinical_data.csv", row.names=FALSE)
```
...
ggsave("PATH/TO/qbio_490_NAME/oncoplot_top#_SKCM.png")
```
